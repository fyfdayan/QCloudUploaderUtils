...
/** 文件名 */
@property (nonatomic, strong, readwrite)    NSString    *fileName;//cos云端文件存储显示的名字
...
typedef NS_ENUM(NSInteger, TXYAuthorityType)//baronjia
{
     /**采用bucket的权限 */
    eInvalidAuth = 0,
     /**文件私有读写的权限 */
...
//文件读写权限
@property(nonatomic,assign) TXYAuthorityType authorityType;//baronjia
//视频信息
...
//文件的权限
@property(nonatomic,assign) TXYAuthorityType fileAuthority;//baronjia
